...
$coach_query = new WP_Query( array(
  'post_type' => 'team-members',
  'category_name' => 'mental-performance-coaches',
));

$trainer_query = new WP_Query( array(
  'post_type' => 'team-members',
  'category_name' => 'sportstrata-consultants',
));

$teams = array(
  'directors' => $director_query->get_posts(),
  'mental performance coaches' => $coach_query->get_posts(),
  'sportstrata consultants' => $trainer_query->get_posts(),
);
